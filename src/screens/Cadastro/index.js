...
export default function Cadastro() {
    ...
    const handleOnSubmit = async () => {
        const apiUrl = 'http://10.0.8.67:3000/users'; // Substitua com o seu endpoint da API, não use localhost, coloque o ip da sua maquina para funcionar em emuladores e devices.
        const userData = {
            ra: ra,
            nome: nome,
            email: email,
